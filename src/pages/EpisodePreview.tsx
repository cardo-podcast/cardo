      ...
      <div className='flex justify-left w-full gap-3 bg-zinc-800 rounded-md mb-2 p-2'>
        ...
        <div className="flex flex-col gap-2 justify-between p-1 w-full">
          <div className="flex flex-col">
            <p className='text-sm text-zinc-400'>{getDate()} - {Math.round(episode.size / 1000000)} MB </p>
            <h1>{episode.title}</h1>
          </div>
          <div className="flex gap-2 justify-end items-center">
            ...
            <button className="w-7 p-[2px] aspect-square flex justify-center items-center hover:text-amber-600 bg-zinc-700 rounded-full"
